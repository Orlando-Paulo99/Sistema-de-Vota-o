...
def login():
	...
	t_login=[
		...
		[sg.Input(key="name",size=(120,15))],
		[sg.Text("Rg")],
		[sg.Input(key="n_rg",size=(120,15))],
		[sg.Text("Titulo")],
		[sg.Input(key="n_titulo",size=(120,15))],
		[sg.Button("Entrar")]
	]
	return sg.Window("Faça seu login",t_login,finalize=True, size=(900,500))
...
def votos():
	...
	return sg.Window("Faça seu voto",t_votos,finalize=True,size=(900,500), element_justification="center")
